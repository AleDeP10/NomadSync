...
## [M2] Shutdown hook registered in io.aledep10.obsidiansync.io.aledep10.obsidiansync.Main, not in SyncOrchestrator
...
**Decision**: shutdown hook registered in `io.aledep10.obsidiansync.io.aledep10.obsidiansync.Main`, which owns the wiring of all components.
...
**Motivation**: `io.aledep10.obsidiansync.io.aledep10.obsidiansync.Main` is the natural place to decide shutdown order — the same place that
