...
class VaultMarkerTest {
    ...
    void create_setsCreatedAtEqualToLastUpdate() {
        VaultMarker marker = VaultMarker.create("id-1", "Alice/vault", "/path/vaults.json", "2026-01-01T00:00:00");
        ...
        assertThat(marker.jsonPath()).isEqualTo("/path/vaults.json");
    }
    ...
    void withRefreshedTimestamp_preservesIdentityFieldsAndCreatedAt() {
        VaultMarker original = VaultMarker.create("id-1", "Alice/vault", "/path/vaults.json", "2026-01-01T00:00:00");
        ...
        assertThat(refreshed.jsonPath()).isEqualTo(original.jsonPath());
